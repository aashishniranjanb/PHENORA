...
export default function Footer() {
  return (
    <footer className="bg-slate-100 border-t border-slate-200 text-slate-600 py-12 text-sm">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          <div>
            <div className="flex items-center space-x-2 mb-4">
              ...
              <span className="text-slate-900 font-extrabold text-lg tracking-wider">PHENORA</span>
            </div>
          ...
          <div>
            <h3 className="text-slate-900 font-bold mb-4 text-xs tracking-widest uppercase">Quick Links</h3>
            <ul className="space-y-2 text-xs font-medium">
              <li><Link href="/technology" className="hover:text-[#059669] transition-colors">Technology Details</Link></li>
              <li><Link href="/spectrae" className="hover:text-[#059669] transition-colors">Simulation Lab</Link></li>
              <li><Link href="/research" className="hover:text-[#059669] transition-colors">Research Matrix</Link></li>
              <li><Link href="/platform" className="hover:text-[#059669] transition-colors">V1-V3 Roadmap</Link></li>
            </ul>
          </div>
          <div>
            <h3 className="text-slate-900 font-bold mb-4 text-xs tracking-widest uppercase">Disclaimer</h3>
