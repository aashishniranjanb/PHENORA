...
export default function IntelligencePanel({
  ...
  return (
    <aside className="w-72 bg-[#091120] border-l border-slate-800 p-4 flex flex-col justify-between shrink-0 font-mono text-xs overflow-y-auto">
      <div>
        <h3 className="text-slate-300 font-bold tracking-wider mb-4 border-b border-slate-800 pb-2 flex items-center justify-between">
        ...
        <div className="mb-4">
          <div className="flex justify-between text-slate-400 text-[11px] mb-1">
            <span>QUALITY</span>
            <span className="text-cyan-400 font-bold">{quality}/100</span>
          </div>
        ...
        {/* Uncertainty */}
        <div className="mb-4 bg-slate-900/80 p-2.5 rounded border border-slate-800 flex justify-between items-center">
        ...
        {/* OOD Score */}
        <div className="mb-4 bg-slate-900/80 p-2.5 rounded border border-slate-800 flex justify-between items-center">
          <span className="text-slate-400">OOD SCORE</span>
          <span className={`font-bold ${ood > 30 ? "text-red-400" : "text-emerald-400"}`}>
        ...
        <div className="mb-4 bg-slate-900/80 p-2.5 rounded border border-slate-800 flex justify-between items-center">
          ...
          <span className="text-cyan-300 font-bold uppercase">{String(trajectory)}</span>
        </div>

        {/* Next Action */}
        <div className="mb-4 bg-slate-900/90 p-3 rounded-lg border border-cyan-500/30">
          <div className="text-[10px] text-slate-400 mb-1">RECOMMENDED ACTION</div>
          <div className="text-sm font-bold text-cyan-400 tracking-wide uppercase">
            {decision}
          </div>
