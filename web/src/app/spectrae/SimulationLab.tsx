        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-5 mb-5">
          ...
          <div className="flex flex-col gap-4">
            ...
            <div className="bg-white border border-slate-200 rounded-xl p-4 shadow-sm">
              ...
              <div className="text-[10px] text-slate-500 font-medium mb-3 leading-relaxed border-l-2 border-[#059669] pl-2 bg-emerald-50/50 py-1 pr-1">
                <strong>Why 1kHz?</strong> The 1kHz frequency is the standard for probing bulk fluid conductivity. At this frequency, we measure physical changes in the liquid (like released ionic metabolites) before high-frequency cellular capacitance effects take over.
              </div>
